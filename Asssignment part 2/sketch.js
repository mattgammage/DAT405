...
function draw(){
  ...
  ellipse(450,150,width,height/3) //Size of shape, in this case it covers one third of the canvas
  fill(255); //Colour of text
  text("Current Temperature in New Orleans is " + weather1.main.temp + "°C", width/2, height/5); //Position of text while still being centred

  size2 = map(weather2.main.humidity, -5, 40, 10, 100);
  fill(map(weather2.main.humidity,0, 20,0, 255), 0, 0);
  ellipse(450,470,width,height/3)
  fill(255);
  ...
  ellipse(450,780,width,height/3)
  fill(255);
